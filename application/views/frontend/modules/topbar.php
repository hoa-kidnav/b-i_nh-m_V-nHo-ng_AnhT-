	...
	<nav class="navbar" style="z-index: 9999">
		<div class="container">
			<div class="col-md-12 col-lg-12">
                ...
                <div id="navbar" class="collapse navbar-collapse $gray-700">
                	<ul class="nav navbar navbar-nav" id="nav1">
                		...
                		<li><a href="thong-tin-tai-khoan">Tài khoảng</a></li>
                		<?php 
                	...
                	<ul class="nav as navbar navbar-nav pull-right" style="margin-top:1000px;" id="nav2">
                		<?php 
                		if($this->session->userdata('sessionKhachHang')){
