...
<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img  class="hinh1"src="<?php echo base_url() ?>public/images/SHOPDOR.png" alt="Logo Construction"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> (87) 0842522044 | 0868738244
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> hoangbmt522@gmail.com | phamanhtu23072000@gmail.com
        </div>
      </div>
